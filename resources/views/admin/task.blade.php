    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-gray-200 shadow-md p-6 space-y-2 m-4">
            ...
            <div class="flex gap-3">
                <a class="px-4 py-1 bg-slate-800 hover:bg-slate-900 text-slate-100" href="{{route('task.edit',$task->id)}}">Edit</a>
                <a class="px-4 py-1 bg-red-800 hover:bg-red-900 text-slate-100" href="{{route('task.destroy',$task->id)}}">Delete</a>
            </div>
        </div>

...
@section('content')
    <div class="w-full md:w-2/3 mx-auto bg-gray-700 pb-6 shadow-xl">
        <div class="">
            <h2 class="py-4 font-semibold text-2xl text-center text-gray-100 drop-shadow-xl">Update Post Form</h2>
            <hr>
        </div>
        ...
        <form action="{{ route('post.update', $post->id) }}" method="post" class="" enctype="multipart/form-data">
            ...
            <div class="px-4 py-2 w-full">
                <input
                    ...
                    placeholder="Post title" type="text" name="post_title" id="post_title" value="{{ $post->title }}">
            ...
            <div class="px-4 py-2 w-full">
                <textarea
                    ...
                    name="description" id="description" cols="30" rows="10">{{ $post->description }}</textarea>

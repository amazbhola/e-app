        ...
        <form action="{{ route('doctor.store') }}" method="post" class="mt-8">
            ...
            <div class="px-4 py-2 w-full">
                <input
                    ...
                    placeholder="Doctor Name" type="text" name="name" id="name" required>
            ...
            <div class="px-4 py-2 w-full flex justify-between gap-4">
                <div class="w-1/2">
                    <input
                        class="py-1 px-0 w-full bg-gray-700 text-gray-100 border-0 border-b-2 border-gray-200 appearance-none focus:outline-none ring-0 peer"
                        placeholder="Degree" type="text" name="degree" id="degree" value="">
                    <label class="capitalize text-gray-100 text-sm" for="degree">Degree</label>
                </div>
                <div class="w-1/2">
                    <input
                        class="py-1 px-0 w-full bg-gray-700 text-gray-100 border-0 border-b-2 border-gray-200 appearance-none focus:outline-none ring-0 peer"
                        placeholder="Specialist" type="text" name="specialist" id="specialist" value="">
            ...
            <div class="px-4 py-2 w-full flex justify-between gap-4">
                <div class="w-1/2">
                    <input
                        class="py-1 px-0 w-full bg-gray-700 text-gray-100 border-0 border-b-2 border-gray-200 appearance-none focus:outline-none ring-0 peer"
                        placeholder="Job Location" type="text" name="job_location" id="job_location" value="">

...
@section('content')
    <div class="w-full md:w-2/3 mx-auto bg-gray-700 pb-6 shadow-xl">
        <div class="">
            <h2 class="py-4 font-semibold text-2xl text-center text-gray-100 drop-shadow-xl">Add Category</h2>
            <hr>
        </div>
        <form action="{{ route('category.store') }}" method="post" class="">
            ...
            <div class="px-4 py-2 w-full">
                <input
                    ...
                    placeholder="Category Title" type="text" name="title" id="title" required>
